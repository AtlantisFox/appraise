...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">
          ...
          <div class="pull-right dlg-control-group" id="dlg-control-group">
            <button type="button" class="btn btn-primary dlg-btn-save" id="dlg-btn-save"><i class="fa fa-arrow-down"></i> 保存</button>
          </div>
    ...
    <div class="row">
      <div class="col-lg-12 form-horizontal" id="plan-meta">
        <div class="form-group col-md-6 col-lg-4">
          <label class="col-sm-3 control-label" for="plan-name">名称</label>
          <div class="col-sm-9">
            <input type="text" class="form-control field-name" id="plan-name">
          </div>
        </div>  <!-- control group: name -->
        <div class="form-group col-md-6 col-lg-4">
          <label class="col-sm-3 control-label" for="plan-remark">备注</label>
		  <div class="col-sm-9">
            <input type="text" class="form-control field-remark" id="plan-remark">
          </div>
        ...
        <div class="form-group col-md-6 col-lg-4">
          ...
          <div class="col-sm-9">
            <div class="input-group date field-deadline">
              <input type="text" class="form-control" id="plan-deadline" required/>
    ...
    <div class="modal fade" id="index-edit-dlg" tabindex="-1" role="dialog" aria-labelledby="index-edit-label" aria-hidden="true">
          ...
          <div class="modal-body">
            <div class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select class="form-control field-name" id="index-name"></select>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="index-weight">权重</label>
                <div class="col-sm-4">
                  <input type="number" class="form-control field-weight" id="index-weight">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="index-remark">指标备注</label>
                <div class="col-sm-9">
                  <p class="form-control-static field-remark" id="index-remark"></p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="index-point">分值</label>
                <div class="col-sm-4">
                  <p class="form-control-static field-point" id="index-point"></p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="index-appraiser">考核部门</label>
                <div class="col-sm-9">
                  <p class="form-control-static field-appraiser" id="index-appraiser"></p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="index-appraisee">被考核部门</label>
                <div class="col-sm-9">
                  <p class="form-control-static field-appraisee" id="index-appraisee"></p>
                </div>
              </div>
            </div>
          </div>  <!-- modal-body -->
